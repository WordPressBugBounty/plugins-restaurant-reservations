 ...
 * @property string|\rtbStripe\Customer $customer ID of the customer.
 * @property null|string|\rtbStripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 * @property int $discount_amount The integer amount in %s representing the total amount of discount that was credited.
 * @property \rtbStripe\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 * @property string|\rtbStripe\Invoice $invoice ID of the invoice.
 * @property \rtbStripe\Collection $lines Line items that make up the credit note
 ...
 * @property null|string|\rtbStripe\Refund $refund Refund related to this credit note.
 ...
 * @property \rtbStripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \rtbStripe\CreditNote the previewed credit note
     */
     ...
     * @throws \rtbStripe\Exception\ApiErrorException if the request fails
     *
     * @return \rtbStripe\Collection the list of credit note line items
     */
