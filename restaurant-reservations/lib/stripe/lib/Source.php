 ...
 * @property \rtbStripe\StripeObject $ach_credit_transfer
 * @property \rtbStripe\StripeObject $ach_debit
 ...
 * @property \rtbStripe\StripeObject $code_verification
 ...
 * @property \rtbStripe\StripeObject $klarna
 ...
 * @property \rtbStripe\StripeObject $multibanco
 * @property null|\rtbStripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \rtbStripe\StripeObject $p24
 * @property \rtbStripe\StripeObject $receiver
 * @property \rtbStripe\StripeObject $redirect
 * @property \rtbStripe\StripeObject $sepa_credit_transfer
 * @property \rtbStripe\StripeObject $sepa_debit
 * @property \rtbStripe\StripeObject $sofort
 * @property \rtbStripe\StripeObject $source_order
 ...
 * @property \rtbStripe\StripeObject $three_d_secure
 ...
 * @property \rtbStripe\StripeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \rtbStripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \rtbStripe\Exception\ApiErrorException if the request fails
     *
     * @return \rtbStripe\Source the detached source
     */
     ...
     * @throws \rtbStripe\Exception\ApiErrorException if the request fails
     *
     * @return \rtbStripe\Collection the list of source transactions
     */
    public function sourceTransactions($params = null, $opts = null)
    {
        $url = $this->instanceUrl() . '/source_transactions';
        list($response, $opts) = $this->_request('get', $url, $params, $opts);
        $obj = \rtbStripe\Util\Util::convertToStripeObject($response, $opts);
