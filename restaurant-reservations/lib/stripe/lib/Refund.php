 ...
 * @property null|string|\rtbStripe\Charge $charge ID of the charge that was refunded.
 ...
 * @property string|\rtbStripe\BalanceTransaction $failure_balance_transaction If the refund failed, this balance transaction describes the adjustment made on your account balance that reverses the initial balance transaction.
 ...
 * @property null|string|\rtbStripe\PaymentIntent $payment_intent ID of the PaymentIntent that was refunded.
 ...
 * @property null|string|\rtbStripe\TransferReversal $source_transfer_reversal The transfer reversal that is associated with the refund. Only present if the charge came from another Stripe account. See the Connect documentation for details.
 ...
 * @property null|string|\rtbStripe\TransferReversal $transfer_reversal If the accompanying transfer was reversed, the transfer reversal object. Only applicable if the charge was created using the destination parameter.
 */
