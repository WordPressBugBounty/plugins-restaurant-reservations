...
namespace rtbStripe\BillingPortal;
 ...
 * @property string|\rtbStripe\BillingPortal\Configuration $configuration The configuration used by this session, describing the features available.
