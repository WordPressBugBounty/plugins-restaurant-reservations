 ...
 * @property null|string|\rtbStripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\rtbStripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\rtbStripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \rtbStripe\StripeObject $spending_controls
 * @property string $status Whether authorizations can be approved on this card.
 * @property string $type The type of the card.
 */
class Card extends \rtbStripe\ApiResource
{
     ...
     *
     * @return \rtbStripe\Issuing\CardDetails the card details associated with that issuing card
     */
