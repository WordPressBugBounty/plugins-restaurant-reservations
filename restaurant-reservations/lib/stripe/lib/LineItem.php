 ...
 * @property \rtbStripe\StripeObject[] $discounts The discounts applied to the line item.
 * @property null|\rtbStripe\Price $price The price used to generate the line item.
 * @property null|int $quantity The quantity of products being purchased.
 * @property \rtbStripe\StripeObject[] $taxes The taxes applied to the line item.
 */
