 ...
 * @property null|(string|\rtbStripe\TaxId)[] $account_tax_ids The account tax IDs associated with the invoice. Only editable when the invoice is a draft.
 ...
 * @property null|string|\rtbStripe\Charge $charge ID of the latest charge generated for this invoice, if any.
 ...
 * @property null|\rtbStripe\StripeObject[] $custom_fields Custom fields displayed on the invoice.
 * @property null|string|\rtbStripe\Customer $customer The ID of the customer who will be billed.
 * @property null|\rtbStripe\StripeObject $customer_address The customer's address. Until the invoice is finalized, this field will equal <code>customer.address</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\rtbStripe\StripeObject $customer_shipping The customer's shipping information. Until the invoice is finalized, this field will equal <code>customer.shipping</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\rtbStripe\StripeObject[] $customer_tax_ids The customer's tax IDs. Until the invoice is finalized, this field will contain the same tax IDs as <code>customer.tax_ids</code>. Once the invoice is finalized, this field will no longer be updated.
 * @property null|string|\rtbStripe\PaymentMethod $default_payment_method ID of the default payment method for the invoice. It must belong to the customer associated with the invoice. If not set, defaults to the subscription's default payment method, if any, or to the default payment method in the customer's invoice settings.
 * @property null|string|\rtbStripe\Account|\rtbStripe\AlipayAccount|\rtbStripe\BankAccount|\rtbStripe\BitcoinReceiver|\rtbStripe\Card|\rtbStripe\Source $default_source ID of the default payment source for the invoice. It must belong to the customer associated with the invoice and be in a chargeable state. If not set, defaults to the subscription's default source, if any, or to the customer's default source.
 * @property \rtbStripe\TaxRate[] $default_tax_rates The tax rates applied to this invoice, if any.
 ...
 * @property null|\rtbStripe\Discount $discount Describes the current discount applied to this invoice, if there is one. Not populated if there are multiple discounts.
 * @property null|(string|\rtbStripe\Discount)[] $discounts The discounts applied to the invoice. Line item discounts are applied before invoice discounts. Use <code>expand[]=discounts</code> to expand each discount.
 ...
 * @property null|\rtbStripe\ErrorObject $last_finalization_error The error encountered during the previous attempt to finalize the invoice. This field is cleared when the invoice is successfully finalized.
 * @property \rtbStripe\Collection $lines The individual line items that make up the invoice. <code>lines</code> is sorted as follows: invoice items in reverse chronological order, followed by the subscription, if any.
 ...
 * @property null|string|\rtbStripe\PaymentIntent $payment_intent The PaymentIntent associated with this invoice. The PaymentIntent is generated when the invoice is finalized, and can then be used to pay the invoice. Note that voiding an invoice will cancel the PaymentIntent.
 * @property \rtbStripe\StripeObject $payment_settings
 ...
 * @property \rtbStripe\StripeObject $status_transitions
 * @property null|string|\rtbStripe\Subscription $subscription The subscription that this invoice was prepared for, if any.
 ...
 * @property \rtbStripe\StripeObject $threshold_reason
 * @property int $total Total after discounts and taxes.
 * @property null|\rtbStripe\StripeObject[] $total_discount_amounts The aggregate amounts calculated per discount across all line items.
 * @property \rtbStripe\StripeObject[] $total_tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class Invoice extends ApiResource
{
     ...
     *
     * @return \rtbStripe\Invoice the upcoming invoice
     */
     ...
     *
     * @return \rtbStripe\Collection the list of lines (InvoiceLineItem)
     */
