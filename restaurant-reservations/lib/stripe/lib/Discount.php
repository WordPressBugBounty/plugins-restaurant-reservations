 ...
 * @property \rtbStripe\Coupon $coupon Hash describing the coupon applied to create this discount.
 * @property string|\rtbStripe\Customer $customer The ID of the customer associated with this discount.
