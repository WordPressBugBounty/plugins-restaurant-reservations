 ...
 * @property null|string|\rtbStripe\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\rtbStripe\Customer $customer The ID of the customer that the bank account is associated with.
