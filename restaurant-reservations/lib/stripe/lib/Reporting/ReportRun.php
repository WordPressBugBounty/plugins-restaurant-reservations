 ...
 * @property \rtbStripe\StripeObject $parameters
 ...
 * @property null|\rtbStripe\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \rtbStripe\ApiResource
{
