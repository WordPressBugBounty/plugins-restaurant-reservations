 ...
 * @property \rtbStripe\OrderItem[] $items The items included in this order return.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|string|\rtbStripe\Order $order The order that this return includes items from.
 * @property null|string|\rtbStripe\Refund $refund The ID of the refund issued for this return.
 */
