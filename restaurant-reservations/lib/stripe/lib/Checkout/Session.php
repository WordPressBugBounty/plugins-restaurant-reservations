 ...
 * @property null|string|\rtbStripe\Customer $customer The ID of the customer for this Session. For Checkout Sessions in <code>payment</code> or <code>subscription</code> mode, Checkout will create a new customer object based on information provided during the payment flow unless an existing customer was provided when the Session was created.
 * @property null|\rtbStripe\StripeObject $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs.
 ...
 * @property \rtbStripe\Collection $line_items The line items purchased by the customer.
 ...
 * @property null|string|\rtbStripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 * @property null|\rtbStripe\StripeObject $payment_method_options Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
 ...
 * @property null|string|\rtbStripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\rtbStripe\StripeObject $shipping Shipping information for this Checkout Session.
 * @property null|\rtbStripe\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 ...
 * @property null|string|\rtbStripe\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property null|\rtbStripe\StripeObject $total_details Tax and discount details for the computed total amount.
 */
class Session extends \rtbStripe\ApiResource
{
    const OBJECT_NAME = 'checkout.session';

    use \rtbStripe\ApiOperations\All;
    use \rtbStripe\ApiOperations\Create;
    use \rtbStripe\ApiOperations\NestedResource;
     ...
     *
     * @return \rtbStripe\Collection the list of items
     */
