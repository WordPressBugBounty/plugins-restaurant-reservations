 ...
 * @property null|\rtbStripe\StripeObject $address The customer's address.
 ...
 * @property null|string|\rtbStripe\Account|\rtbStripe\AlipayAccount|\rtbStripe\BankAccount|\rtbStripe\BitcoinReceiver|\rtbStripe\Card|\rtbStripe\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you are using payment methods created via the PaymentMethods API, see the <a href="https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 ...
 * @property null|\rtbStripe\Discount $discount Describes the current discount active on the customer, if there is one.
 ...
 * @property \rtbStripe\StripeObject $invoice_settings
 ...
 * @property null|\rtbStripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \rtbStripe\Collection $sources The customer's payment sources, if any.
 * @property \rtbStripe\Collection $subscriptions The customer's current subscriptions, if any.
 ...
 * @property \rtbStripe\Collection $tax_ids The customer's tax IDs.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \rtbStripe\Customer the updated customer
     */
     ...
     *
     * @return \rtbStripe\Collection the list of customer balance transactions
     */
     ...
     * @throws \rtbStripe\Exception\ApiErrorException if the request fails
     *
     * @return \rtbStripe\CustomerBalanceTransaction
     */
     ...
     * @throws \rtbStripe\Exception\ApiErrorException if the request fails
     *
     * @return \rtbStripe\Collection the list of payment sources (AlipayAccount, BankAccount, BitcoinReceiver, Card or Source)
     */
     ...
     * @throws \rtbStripe\Exception\ApiErrorException if the request fails
     *
     * @return \rtbStripe\AlipayAccount|\rtbStripe\BankAccount|\rtbStripe\BitcoinReceiver|\rtbStripe\Card|\rtbStripe\Source
     */
     ...
     * @throws \rtbStripe\Exception\ApiErrorException if the request fails
     *
     * @return \rtbStripe\Collection the list of tax ids
     */
