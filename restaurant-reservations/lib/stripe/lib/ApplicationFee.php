 ...
 * @property string|\rtbStripe\Account $account ID of the Stripe account this fee was taken from.
 ...
 * @property string|\rtbStripe\StripeObject $application ID of the Connect application that earned the fee.
 * @property null|string|\rtbStripe\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this collected application fee on your account balance (not including refunds).
 * @property string|\rtbStripe\Charge $charge ID of the charge that the application fee was taken from.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|string|\rtbStripe\Charge $originating_transaction ID of the corresponding charge on the platform account, if this fee was the result of a charge using the <code>destination</code> parameter.
 ...
 * @property \rtbStripe\Collection $refunds A list of refunds that have been applied to the fee.
 */
class ApplicationFee extends ApiResource
{
     ...
     *
     * @return \rtbStripe\Collection the list of fee refunds
     */
     ...
     * @throws \rtbStripe\Exception\ApiErrorException if the request fails
     *
     * @return \rtbStripe\ApplicationFeeRefund
     */
